...
<body>
    ...
    <section class="datosViaje">
        <h2 id="destino"> Destino: Vergel</h2>
        <h3 id="horaSalida">Hora de salida: <p>2:00 am</p></h3>
        <h3 id="central">Central: <p>El Vergel</p></h3>
        <h3 id="fecha">Fecha de salida: <p>05/11/2023</p></h3>
        <form class = "formDatos" id="formDatos" action ="./php/registrarAsientosVergel.php"> 
            <!-- Nombre -->
            <label for="nombre">Nombre del comprador:</label>
            <input type="text" id="nombre2" name="nombre"
            <?php if(isset($_SESSION['loginState'])){
                echo 'readonly ';
